...
class AboutUsController extends Controller
{
    ...
    public function update(Request $request)
    {
        ...
        $this->checkIfImageChange($request, 'institute_dean_image', $record->institute_dean_image);
        $this->checkIfImageChange($request, 'chairman_of_board_image', $record->chairman_of_board_image);
        $this->checkIfImageChange($request, 'organizational_char_image', $record->organizational_char_image);
    ...
    public function checkIfImageChange(Request $request, $imageName, $oldImage)
    {
        if ($request->has($imageName)) {
            $data[$imageName] = $this->uploadedImage($request, 'institute_dean_image');
